...
function showAnswer(answer) {
    if (textContent.trim().length) resultArea.style.display = "block";
    resultArea.innerHTML = `Your text has <span class="number">${alphabeticCharCount}</span> alphabetic characters, <span class="number">${totalVowelCount}</span> are vowels.<br>
